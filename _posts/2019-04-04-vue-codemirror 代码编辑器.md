...
## 相关网址
1. [Vue 官方插件库推荐的集成实现](https://github.com/surmon-china/vue-codemirror)
	* 这个实现做的比较全面，但不支持动态语法高亮的切换
2. [codemirror 支持的语言类型](https://codemirror.net/mode/)
3. [codemirror 官网](https://codemirror.net/index.html)

## 实现效果
![](http://asing1elife.com/sources/images/B92F8590-CC7A-49E8-B5E0-0D10633A64BE.png)
